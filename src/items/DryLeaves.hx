...
class DryLeaves extends Item
{
    
    public static final ICON_SPRITE = "assets/item_dryleaves.png";
    
    public static final PLACED_SPRITE = "assets/item_dryleaves_placed.png";
