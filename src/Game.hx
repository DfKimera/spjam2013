...
class Game extends FlxGame {
	...
	public function new() {
		Game.instance = this;
		super(800, 600, LanguageSelect, 60, 30, true);

		//FlxG.camera.antialiasing = true;
		FlxG.plugins.addPlugin(new FlxMouseControl());
     ...
     */
	public static function goToLanguageSelect():Void {
		Game.transitionToScene(new LanguageSelect());
	}
