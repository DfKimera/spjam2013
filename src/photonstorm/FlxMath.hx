 ...
 */
class FlxMath {
    public static var getrandmax:Int = 0x7FFFFFFF;
    static var mr:UInt = 0;
    static var cosTable:Array<Dynamic> = [];
    static var sinTable:Array<Dynamic> = [];

    static var coefficient1:Float = Math.PI / 4;
    public static final RADTODEG:Float = 180 / Math.PI;
    public static final DEGTORAD:Float = Math.PI / 180;
	 ...
	 * @see getCosTable
	 */
    public static function sinCosGenerator(length:UInt, sinAmplitude:Float = 1.0, cosAmplitude:Float = 1.0, frequency:Float = 1.0):Array<Dynamic> {
	 ...
	 * @see sinCosGenerator
	 */
    public static function getSinTable():Array<Dynamic> {
        return sinTable;
    }
	 ...
	 * @see sinCosGenerator
	 */
    public static function getCosTable():Array<Dynamic> {
        return cosTable;
    }
	 ...
	 */
    public static function rand(min:Null<Float> = null, max:Null<Float> = null, excludes:Array<Dynamic> = null):Int {
        if (Math.isNaN(min)) {
            min = 0;
        }
        ...
        if (excludes != null) {
            ...
            excludes.sort((a, b) -> Std.int(a) - Std.int(b));
