...
class FlxMouseControl extends FlxBasic {
    ...
    static var clickStack:Array<Dynamic> = [];
    ...
    function assignClickedSprite() {
        ...
        var clickStackDebug:Array<Dynamic> = [];
    ...
    function sortHandler(item1:FlxExtendedSprite, item2:FlxExtendedSprite):Int {
        var v1:Dynamic = Reflect.field(item1, sortIndex);
        var v2:Dynamic = Reflect.field(item2, sortIndex);
        if (v1 < v2) {
            return sortOrder;
        } else if (v1 > v2) {
            return -sortOrder;
